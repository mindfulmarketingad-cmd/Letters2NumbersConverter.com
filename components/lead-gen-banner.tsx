    ...
    <section id="catering" className="py-20 px-4 sm:px-6 lg:px-8 bg-[#77567A]" ref={ref}>
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="fade-up flex flex-col sm:flex-row items-center justify-center gap-4">
          <button className="group flex items-center gap-2 px-8 py-4 rounded-lg bg-white text-[#2F323A] font-semibold text-sm hover:bg-white/90 transition-colors shadow-lg">
            Get Free Quotes
