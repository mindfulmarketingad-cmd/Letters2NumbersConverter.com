...
const toolRegistry: Record<string, { name: string; description: string; category: string; href: string }> = {
  ...
  'ai-slop-checker': {
    ...
    description: 'Detect whether text or images were generated by AI. Get a confidence score, detected patterns, readability scores, and strip hidden AI fingerprints from any content.',
    category: 'Text Tools',
