...
const tools = [
  ...
  },
  {
    ...
    description: "Tapcode Translator - Convert messages to tap code using the 5x5 grid cipher. Used by prisoners in Vietnam War POW camps. Encode with dots, numbers, or knock patterns instantly.",
