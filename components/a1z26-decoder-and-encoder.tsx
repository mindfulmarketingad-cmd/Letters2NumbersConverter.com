...
export function A1Z26DecoderAndEncoder() {
  ...
  const handleDownload = useCallback(() => {
    ...
    element.setAttribute('download', `a1z26-${mode}-output.txt`)
    ...
    <div className="w-full space-y-6">
      ...
      <div>
        ...
        <textarea
          ...
          placeholder={
            mode === 'encode' ? 'Enter letters (e.g., HELLO)' : 'Enter numbers (e.g., 8 5 12 12 15)'
          }
        ...
        <p className="text-xs text-muted-foreground mt-2">
          {mode === 'encode'
            ...
            : 'Use spaces or commas to separate numbers. Numbers should be 1-26.'}
        </p>
      </div>
      ...
      <div className="mt-8 p-4 bg-secondary/50 border border-border rounded-lg">
        <h3 className="font-semibold text-foreground mb-2">A1Z26 Chart Reference</h3>
