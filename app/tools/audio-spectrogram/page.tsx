...
export const metadata: Metadata = {
  title: "Audio Spectrogram Analyzer - Visualize Audio Frequencies",
  description: "Free online audio spectrogram analyzer. Upload WAV, FLAC, OGG, MP3, or M4A files to visualize audio frequencies. Detect hidden messages in audio steganography. All processing done locally in your browser.",
  keywords: ["audio spectrogram", "spectrogram analyzer", "audio visualization", "frequency analysis", "steganography", "audio steganography", "hidden audio messages", "WAV analyzer", "MP3 spectrogram"],
  openGraph: {
    title: "Audio Spectrogram Analyzer - Visualize Audio Frequencies",
    description: "Free online audio spectrogram analyzer. Upload audio files to visualize frequencies and detect hidden messages.",
    type: "website",
  },
}
      ...
      <main className="flex-1 container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto">
          ...
          <nav className="flex items-center gap-2 text-sm text-muted-foreground mb-8">
            ...
            <span>/</span>
            <span className="text-foreground">Audio Spectrogram</span>
          </nav>
          ...
          <div className="text-center mb-12">
            ...
            <h1 id="audio-spectrogram-analyzer" className="text-3xl sm:text-4xl lg:text-5xl font-bold text-foreground mb-6 text-balance leading-tight">
          ...
          <div id="tips" className="bg-card/50 border border-border rounded-xl p-6 sm:p-8 mb-8">
            <h2 className="text-xl font-bold text-foreground mb-4">Tips for Better Analysis</h2>
            <ul className="list-disc list-inside text-muted-foreground space-y-2">
