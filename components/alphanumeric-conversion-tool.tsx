...
export function AlphanumericConversionTool() {
  ...
  const { scheduleTracking, resetTracking, showUpgradeModal, setShowUpgradeModal, remainingUses } = useInstantTrackUsage("Alphanumeric Conversion Tool")
  ...
  const downloadAsFile = () => {
    ...
    element.download = `alphanumeric-conversion-${Date.now()}.txt`
