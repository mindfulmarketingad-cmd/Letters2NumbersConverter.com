...
export function MEqToMgCalculator() {
  ...
  return (
    <div className="w-full max-w-4xl mx-auto p-8 bg-background rounded-lg">
      <div className="mb-8">
        <h2 className="text-3xl font-bold text-black dark:text-white mb-2">mEq to mg Calculator</h2>
      ...
      <div className="bg-secondary/50 p-6 rounded-lg border border-border mb-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
          {/* Ion Selection */}
          <div>
            <label className="block text-sm font-semibold text-black dark:text-white mb-2">Select Ion</label>
            <select
          ...
          {/* Value Input */}
          <div>
            <label className="block text-sm font-semibold text-black dark:text-white mb-2">Value</label>
            <input
              type="number"
              value={value}
          ...
          {/* Unit Selection */}
          <div>
            <label className="block text-sm font-semibold text-black dark:text-white mb-2">Unit</label>
            <select
              value={unit}
      ...
      {result && selectedIon && (
        <div className="bg-green-50 dark:bg-green-950 p-6 rounded-lg border border-green-200 dark:border-green-800 mb-6">
          <h3 className="text-lg font-semibold text-black dark:text-white mb-4">Result</h3>
